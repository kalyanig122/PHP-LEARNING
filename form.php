...
<form  action= "./submitdata.php"  method ="post"  class="row g-3 needs-validation" enctype="multipart/form-data">
<!-- novalidate -->
  <div class="col-md-4">
  ...
  <div class="col-md-4">
    ...
    <div class="input-group has-validation">
      ...
      <input type="text" name="" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
